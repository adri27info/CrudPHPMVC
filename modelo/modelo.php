...
class Modelo
{
    ...
    {
        try {
            $query = BD::crearConexion()->prepare("SELECT * FROM usuarios where id = :id");
    ...
    {
        try {
            $query = BD::crearConexion()->prepare("INSERT INTO usuarios(id, nombre, direccion, telefono) VALUES (:id, :nombre, :direccion, :telefono)");
            $query->bindParam(':id', $id);
