...
<body>
    ...
    <main>
        <form id="formulario" class="formulario actualizar" action="index.php?metodo=update&id=<?php echo $usuario[0]["id"]; ?>" method="POST">
            <input type="hidden" name="id_usuario" value="<?php echo $usuario[0]["id"]; ?>" />
            <label for="nombre_usuario">Nombre: </label>
            <input type="text" name="nombre_usuario" id="nombre_usuario" placeholder="Introduce el nombre del usuario" value="<?php echo $usuario[0]["nombre"];  ?>">
            ...
            <input type="text" name="direccion_usuario" id="direccion_usuario" placeholder="Introduce la direccion del usuario" value='<?php echo $usuario[0]["direccion"];  ?>'>
            ...
            <input type="text" name="telefono_usuario" id="telefono_usuario" placeholder="Introduce el telefono del usuario" value='<?php echo $usuario[0]["telefono"];  ?>'>
